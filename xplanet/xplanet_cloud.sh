...
pat=/Users/Joaquim/webprojects/pidashboard/xplanet/img/ # destination de l'image téléchargée
tmp=$pat"tmp_clouds.jpg" # nom du fichier temporaire
img=$pat"clouds.jpg"     # nom du fichier final
...
if [ -f $tmp ] ; then # si le fichier a bien été téléchargée...
  ...
  chown -R Joaquim:www-data $pat && chmod -R 775 $pat # change les droits sur le fichier
fi